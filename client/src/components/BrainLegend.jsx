...
const BrainLegend = () => (
  <div className="fixed z-20 hidden sm:block" style={{ bottom: '3.5rem', left: '1.25rem' }}>
    <div className="med-panel px-3 py-2 rounded">
      ...
      <div className="flex flex-col gap-0.5">
        {Object.entries(BRAIN_MAPPING).map(([sensor, m]) => (
          <div key={sensor} className="flex items-center gap-1.5 text-[10px]" style={{ color: 'var(--text-secondary)' }}>
